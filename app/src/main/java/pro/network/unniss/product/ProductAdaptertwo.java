...
public class ProductAdaptertwo extends RecyclerView.Adapter<ProductAdaptertwo.MyViewHolder> {
    ...
    public ProductAdaptertwo(Context mainActivityUser, List<ProductListBean> productBeans, ProductItemClick productItemClick, SharedPreferences sharedPreferences) {
    ...
    public ProductAdaptertwo.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_singleproducttwo, parent, false);

        return new ProductAdaptertwo.MyViewHolder(itemView);
    }
    ...
    private void doCallCartChange(int newQuan, ProductAdaptertwo.MyViewHolder holder, int position) {
