...
public class CategoryAdapter extends RecyclerView.Adapter<pro.network.unniss.chip.CategoryAdapter.MyViewHolder> {


    private final Context context;
    private final pro.network.unniss.chip.OnChip onBlock;
    private ArrayList<ChipBean> blogArrayList;
    private String selectedPosition;

    public CategoryAdapter(Context context, ArrayList<ChipBean> blogArrayList, pro.network.unniss.chip.OnChip onBlock, String selectedPosition) {
