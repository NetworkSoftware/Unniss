...
public class PaymentActivity extends AppCompatActivity implements PaymentResultListener, AddressItemClick {
    ...
    private void callGpayOrOnline() {
        ...
        checkout.setImage(R.drawable.unniss);
        JSONObject object = new JSONObject();
        try {

            object.put("name", "Unniss");
    ...
    private void validatePincode(final ProgressBar progressBar,
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET, AppConfig.GET_PINCODE, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
    ...
    private void addOrUpdateAddress(final Address address1, final boolean isUpdate,
        ...
        StringRequest strReq = new StringRequest(Request.Method.PUT, addAddress, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                hideDialog();
                Log.d("Register Response: ", response);
